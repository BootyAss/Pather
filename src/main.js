import { Types, Colors, Points, Logos, animSpeeds, Mazes, Algs } from './lib.js';
...
var Visualize = async () => {
    ...
    let [path, visited] = current.Algorithm(parseInt(x), parseInt(y), parseInt(start), parseInt(end), walls);
    if (path == null)
